...
See [Configurator Development](https://github.com/cleanflight/cleanflight-configurator#development) for how to build the Configurator.

### Flashing a target with the Configurator on Ubuntu 20.04
